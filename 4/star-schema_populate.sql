...
--         INNER JOIN d_utilizador ON incidencia.email = d_utilizador.email INNER JOIN d_tempo ON (something) INNER JOIN d_local ON d_local.latitude = item.latitude AND d_local.longitude = item.longitude INNER JOIN d_lingua ON 
